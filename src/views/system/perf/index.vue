<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="perfList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键id" align="center" prop="empId" />
      ...
      <el-table-column label="完成比例" align="center" prop="completionRatio" />
      ...
      <el-table-column label="工作时长" align="center" prop="workDuration" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="员工工号" prop="employeeNumber">
          <el-input v-model="form.employeeNumber" placeholder="请输入员工工号" />
        </el-form-item>
        <el-form-item label="工作类型" prop="workType">
        ...
        <el-form-item label="完成结果" prop="completionResult">
          <el-input v-model="form.completionResult" placeholder="请输入完成结果" />
        </el-form-item>
        <el-form-item label="完成日期" prop="completionDate">
          <el-date-picker clearable
        ...
        <el-form-item label="工作时长" prop="workDuration">
          <el-input v-model="form.workDuration" placeholder="请输入工作时长" />
        </el-form-item>
        <el-form-item label="扩展字段1" prop="extensionField1">
          <el-input v-model="form.extensionField1" placeholder="请输入扩展字段1" />
        </el-form-item>
        <el-form-item label="扩展字段2" prop="extensionField2">
          <el-input v-model="form.extensionField2" placeholder="请输入扩展字段2" />
        </el-form-item>
        <el-form-item label="扩展字段3" prop="extensionField3">
          <el-input v-model="form.extensionField3" placeholder="请输入扩展字段3" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除员工绩效编号为"' + empIds + '"的数据项？').then(function() {
        return delPerf(empIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/perf/export', {
        ...this.queryParams
